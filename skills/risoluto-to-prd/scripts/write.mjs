 ...
 *
 * Phase 3.2 of docs/planning-pipeline-roadmap.md. Idempotent on re-run:
...
function suggestPrCommand(slug, branchName) {
  ...
  const body = [
    ...
    "",
    "Generated by /risoluto-to-prd (Phase 3.2 of docs/planning-pipeline-roadmap.md). PRD is canonical in git; Linear Project description is a generated mirror.",
    "",
