...
async function loadRoutesModuleWithMocks() {
  ...
  const registerWorkflowRunRoutesSpy = vi.fn();
  ...
  vi.doMock("../../src/http/routes/workflow-runs.js", () => ({
    registerWorkflowRunRoutes: registerWorkflowRunRoutesSpy,
  }));
