...
- Skills PRINT the PR command; never run it. No force-push. Never skip git hooks (--no-verify). (Convention only — the PreToolUse guard hook that enforced this was removed.)
