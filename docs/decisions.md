...
| 2 | 2026-05-24 | Canonical org is `risolutohq` | active | New public home; legacy stays at `OmerFarukOruc/risoluto-legacy`. | — |
| 3 | 2026-05-24 | Canonical repo is `risolutohq/risoluto`, public | active | MIT, public, single canonical home. | — |
| 4 | 2026-05-24 | Curated snapshot import, no git history | active | `0.1.0` is a fresh import, not a graft of legacy history. | — |
...
| 6 | 2026-05-24 | Linear is canonical for internal planning | active | GitHub Issues is public intake / mirror only. | [research-workflow.md](./research-workflow.md) |
...
A `quarantine.json` marker can flag uncertain imported code during Step 3 (curated snapshot). Decisions about quarantined code are added here as they're made — `keep`, `rewrite`, `delete` — with the snapshot import PR linked.
