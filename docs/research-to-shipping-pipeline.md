...
- **No auto-PR (convention).** Skills branch, commit, and push but never run `gh pr create` — they print it. Opening or merging a PR (and any force-push) is the operator's explicit terminal action.
