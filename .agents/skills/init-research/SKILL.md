...
The `research/` submodule (`risolutohq/risoluto-research`, private) is a hard prerequisite for any Codex work in this repo per `AGENTS.md`. This skill verifies it and initializes it if missing.
